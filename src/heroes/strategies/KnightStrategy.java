...
public final class KnightStrategy implements HeroStrategy {

    private static class Const {

        public static final float MINUS_DMG = -0.2f;
        public static final float PLUS_DMG = 0.5f;
        public static final int HEAL_STRAT_LIMIT = 3;
        public static final int BUFF_STRAT_LIMIT = 2;
        public static final int HEAL_STRAT = 4;
        public static final int BUFF_STRAT = 5;
    }
